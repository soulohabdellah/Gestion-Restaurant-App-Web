...
<div class="table-responsive">
    <table class="table ">
        ...
        <tbody>
            ...
            <tr @if($message->lu == false) style="background-color: #f2f2f2;" @else style="background-color: #ffffff;" @endif>
                <td>{{ $message->id }}</td>
                <td>{{ $message->nom }}</td>
                <td>{{ $message->email }}</td>
                <td>
                    ...
                    N'est pas exist
                    @else
                    <a href="{{ $message->fichier }}">Exist</a>
                    @endif
                </td>
                ...
                <td>
                    ...
                    @if($message->lu==false)
                    <a href="/modify-message/{{ $message->id }}">
                        <i class="fas fa-eye" style="color: #5ddbf4;"></i>
                    </a>
                    @endif
                </td>
            </tr>
