...
<main>
    <div class="container py-5">
      ...
      @endif
        <h1 class="text-center mb-5">Connexion client</h1>
<form  class="was-validated" action="auhthentification-client/verifier-client" method="POST">
    @csrf
<div class="mb-3">
...
<a href="/creer-compte-client">Créer une compte</a>
    </div>
</main>
