  ...
  <body onload="setActiveLink()">
    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="container">
            ...
            @endif
            <form class="was-validated" method="POST" action="setting-administrateur">
              @csrf
            <div class="mb-3">
                <label class="form-label">Email address</label>
                <input type="email" class="form-control" id="Email" name="Email" value="<?php echo $administrateur->email; ?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Entrez votre email" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Name" name="Name" aria-describedby="emailHelp" value="<?php echo $administrateur->name; ?>" required>
            </div>
            ...
            <div class="mb-3">
              ...
              <script>
                  ...
                  function checkchamps(){
                    ...
                    if (confirm.value ==password.value &&confirm.value != "" && password.value != "" && email.value != ""  && Name.value != "" ) {
                      Btn.disabled = false;
                    } else {
                      Btn.disabled = true;
                    }
