...
<form   enctype="multipart/form-data" class="was-validated" action="/creer-produit" method="POST">
    @csrf
...
<div class="mb-3">
  ...
  <input type="number" class="form-control" name="Prix" id="Prix" aria-describedby="emailHelp" required>
</div>
<div class="mb-3">
  <label  class="form-label">Quantite stock</label>
  <input type="number" class="form-control" name="Count" id="Count" aria-describedby="emailHelp" required>
</div>
<div class="mb-3">
  <label  class="form-label">Temp</label>
  <input type="number" class="form-control" name="Temp" id="Temp" aria-describedby="emailHelp"  required>
</div>
<div class="mb-3">
...
<div class="mb-3 form-check">
  <input type="checkbox" class="form-check-input" id="Frite" name="Frite" >
  <label class="form-check-label" for="exampleCheck1">Frite</label>
</div>
<div class="mb-3 form-check">
  <input type="checkbox" class="form-check-input" id="Boisson" name="Boisson" >
  <label class="form-check-label" for="exampleCheck1">Boisson</label>
</div>
<div class="mb-3 form-check">
  <input type="checkbox" class="form-check-input" id="Sauce" name="Sauce" >
...
<div class="mb-3">
  ...
  <button type="submit" id="ajouter-btn"class="btn btn-primary">Ajouter</button>
</form>
</div>
    </div>
<script>
  function checkchamps(){
    ...
    if ( Nom.value != "" && Description.value != ""&& Categorie.value != ""&& Prix.value != ""&& Count.value != "" && Image.value != "" && Temp.value != "" ) {
      Btn.disabled = false;
    } else {
      Btn.disabled = true;
    }
