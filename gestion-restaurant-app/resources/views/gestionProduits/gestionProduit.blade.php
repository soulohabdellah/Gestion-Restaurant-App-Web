  ...
  <table class="table table-striped">
    <thead>
      <tr>
        ...
        <th class="col-1">Avec</th>
        <th class="col-1">Temp</th>
    ...
    <tbody>
      @foreach ($listProduits as $produit)
        <tr>
          ...
          <td><strong>{{ $produit->prix }} DH</strong></td>
          <td>
            @if($produit->frite==true)
            <i class="fas fa-french-fries"></i>
            @endif
            @if($produit->boisson==true)
            <i class="fas fa-coffee"></i>
            @endif
            @if($produit->sauce==true)
            <i class="fas fa-pepper-hot"></i>
            @endif


          </td>
          <td><strong>{{ $produit->temp }} min</strong></td>

          <td>{{ $produit->description }}</td>
          <td>
            <a href="/delete-produit/{{ $produit->id }}">
