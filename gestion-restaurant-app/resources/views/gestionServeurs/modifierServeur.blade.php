 ...
 <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
      <div class="container">
        <h1>Modifier Serveur : {{$serveur->nom}}</h1>
   
<form class="was-validated" method="POST" action="modify-serveur/{{$serveur->id}}">
  @csrf
<div class="mb-3">
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="CIN" name="CIN" aria-describedby="emailHelp" value="<?php echo $serveur->CIN; ?>" required>
</div>
<div class="mb-3">
...
<div class="mb-3">
  <div class="form-group">
    ...
    <div class="input-group date" id="datePicker" data-target-input="nearest">
      <input type="text" class="form-control datetimepicker-input" data-target="#datePicker" name="date_recrutement" id="date_recrutement" value="<?php echo $serveur->date_recrutement; ?>"/>
