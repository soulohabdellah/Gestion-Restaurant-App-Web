...
<html lang="en">
 ...
 <meta charset="utf-8">
  ...
  <form  class="was-validated" action="/creer-livreur" method="POST">
    @csrf
<div class="mb-3">
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="Telephone" name="Telephone" aria-describedby="emailHelp"  required>
</div>
<div class="mb-3">
    <label  class="form-label">CIN</label>
    <input type="text" class="form-control" id="CIN" name="CIN" aria-describedby="emailHelp"  required>
</div>
<div class="mb-3">
...
<div class="mb-3">
  <div class="form-group">
    ...
    <div class="input-group date" id="datePicker" data-target-input="nearest">
      <input type="text" class="form-control datetimepicker-input" data-target="#datePicker" name="date_recrutement" id="date_recrutement" required/>
