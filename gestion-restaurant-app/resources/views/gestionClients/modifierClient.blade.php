 ...
 <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
      <div class="container">
        <h1>Modifier client : {{$client->nom}}</h1>
<form class="was-validated" method="POST" action="modify-client/{{$client->id}}">
  @csrf
<div class="mb-3">
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="Nom" name="Nom" aria-describedby="emailHelp" value="<?php echo $client->nom; ?>" required>
</div>
<div class="mb-3">
    <label  class="form-label">Prenom</label>
    <input type="text" class="form-control" id="Prenom" name="Prenom" aria-describedby="emailHelp" value="<?php echo $client->prenom; ?>" required>
</div>
<div class="mb-3">
  <label  class="form-label">Telephone</label>
  <input type="text" class="form-control" id="Telephone" name="Telephone" aria-describedby="emailHelp" value="<?php echo $client->telephone; ?>" required>
</div>
<div class="mb-3">
    <label  class="form-label">Adresse</label>
    <input type="text" class="form-control" id="Adresse" name="Adresse" aria-describedby="emailHelp" value="<?php echo $client->adresse; ?>" required>
</div>
<div class="mb-3">
